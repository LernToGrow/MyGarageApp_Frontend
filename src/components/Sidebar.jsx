    ...
    <aside className="w-60 flex flex-col min-h-screen" style={{ background: 'linear-gradient(180deg, #0f172a 0%, #1e293b 100%)' }}>
      ...
      <nav className="flex-1 py-4 px-3 space-y-0.5">
        {links.map(({ to, label, icon }) => (
          <NavLink
            ...
            style={({ isActive }) => isActive ? { background: 'linear-gradient(135deg, #E85D04cc, #f97316aa)', boxShadow: '0 2px 8px rgba(232,93,4,0.3)' } : {}}
          >
      ...
      <div className="px-3 pb-5">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-slate-400 hover:text-white hover:bg-slate-700/50 transition-all duration-150"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
